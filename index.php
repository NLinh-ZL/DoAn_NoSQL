...
<main>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-info mb-30">
                        ...
                        <div class="info-caption">
                            <p>Hà Nội, 7554 2/9</p>
                            <span>Việt Nam, TP Hồ Chí Minh - 300475</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="about-img ">
                        <div class="about-font-img">
                            <img src="inc/assets/img/gallery/about2.png" alt="">
                        </div>
                        <div class="about-back-img d-none d-lg-block">
                            <img src="inc/assets/img/gallery/about1.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="team-area " style="padding: 20px;">
        <div class="container">
          <img src="./img/z5705898604374_853520b1ff9a915c388a5ea6610d0617.jpg" style="margin-left: 50px;" height="700px" alt="">
        </div>
    </div>
    <!-- Team Ara End -->
    <!--? Testimonial Start -->
