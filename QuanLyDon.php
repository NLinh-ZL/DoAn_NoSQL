                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content mt-2 mb-3" id="pills-tabContent" style="border-top: 3px solid #dc3545;">
                            <div class="tab-pane fade  <?= ($active == null || $active == 'TongDon')  ? 'show active' : '' ; $page = $active !== 'TongDon' ? 1 : (isset(($_GET['page'] ))? $_GET['page']:1 ); ?> " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            ...
                            <div class="tab-pane fade <?= $active === 'GiaoThanhCong'  ? 'show active' : '' ; $page = $active !== 'GiaoThanhCong' ? 1 : (isset(($_GET['page'] ))? $_GET['page']:1 ); ?> " id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">STT</th>
                            ...
                            <div class="tab-pane fade  <?= $active === 'DangGiao'  ? 'show active' : ''; $page = $active !== 'DangGiao' ? 1 : (isset(($_GET['page'] ))? $_GET['page']:1 ); ?>" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">STT</th>
                            ...
                            <div class="tab-pane fade  <?= $active === 'HuyGiao'  ? 'show active' : ''; $page = $active !== 'HuyGiao' ? 1 : (isset(($_GET['page'] ))? $_GET['page']:1 ); ?>" id="pills-huy" role="tabpanel" aria-labelledby="pills-huy-tab">
