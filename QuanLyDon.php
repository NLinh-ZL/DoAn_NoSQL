...
$total_pages_TongDon = VanDon::countAll($pdo,$limit);
$total_pages_GiaoThanhCong = VanDon::countAll($pdo,$limit,'Giao hàng thành công');
$total_pages_HuyGiao = VanDon::countAll($pdo,$limit,'Hủy giao');
$total_pages_DangGiao = VanDon::countAll($pdo,$limit,'Đang giao');
