...
if (isset($_GET['action']) && isset($_GET['idVD']) && isset($NhanVienDangNhap)) {
    $action = $_GET['action'];
    $idVD = $_GET['idVD'];
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills nav-secondary" style=" background: #f8f8fa; margin-bottom:15px" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-itemw flex-fill text-center">
                                <a class="nav-link <?= $active === 'CanGiao'  ? 'active' : '' ?>" style="padding: 20px;margin: 0px;" id="pills-CanGiao-tab" data-bs-toggle="pill" href="#pills-CanGiao" role="tab" aria-controls="pills-CanGiao" aria-selected="false">
                                    <h5 style="color: #000;">
                        ...
                        <div class="tab-content mt-2 mb-3" id="pills-tabContent" style="border-top: 3px solid #dc3545;">
                            <div class="tab-pane fade  <?= ($active == null || $active == 'ChoXacNhan')  ? 'show active' : '';$page = $active !== 'ChoXacNhan' ? 1 : ($_GET['page']); ?> " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">

                                <table class="table">
                                    <thead>
                                        <tr>
                                            <!-- <th scope="col">STT</th> -->
                                            <th scope="col">Mã VD</th>


                                            <th scope="col">Người gửi</th>
                                            <th scope="col">Địa chỉ lấy</th>
                                            <th scope="col">SDT</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php $idkh = $order['idKhachHang'];
                                                $kh = KhachHang::getUserById($pdo, $idkh) ?>
                                                <td><?= $kh['hoTen'] ?></td>
                                                <td><?= htmlspecialchars($kh['diaChi']['diaChi']) ?></td>
                                                <td><?= $kh['SDT'] ?></td>
                                                ...
                                                <td><a href="QuanLyDon_Shipper.php?action=layhang&idVD=<?= $order['idVD'] ?>">
                            ...
                            <div class="tab-pane fade  <?= $active === 'CanGiao'  ? 'show active' : ''; $page = $active !== 'CanGiao' ? 1 : ($_GET['page']); ?>" id="pills-CanGiao" role="tabpanel" aria-labelledby="pills-CanGiao-tab">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $order['loaiHang'] ?></td>
                                                <td><?= $tongKhoiLuong ?> kg</td>
                                                <td><a href="QuanLyDon_Shipper.php?active=CanGiao&action=giaothanhcong&idVD=<?= $order['idVD'] ?>">
                                                        <button class="btn btn-success " style="margin: 5px;">
                                                            Giao Thành công

                                                        </button>
                                                    </a>
                                                    <a href="QuanLyDon_Shipper.php?active=CanGiao&action=huygiao&idVD=<?= $order['idVD'] ?>">
                                                        <button class="btn btn-danger ">
                                                            Hủy Giao
                            ...
                            <div class="tab-pane fade  <?= $active === 'DangGiao'  ? 'show active' : '';
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $STT = 1;
                                        $offset = ($page - 1) * $limit;
                                        $DangLay = VanDon::getDonHang_Shipper($pdo, $NhanVienDangNhap['idBC'], $NhanVienDangNhap['idNV'], $limit, $offset, 'Chuyển đến bưu cục');
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $order['loaiHang'] ?></td>
                                                <td><?= $tongKhoiLuong ?> kg</td>
                                                <td><?= $order['lastStatus']['trangthai'] ?? 'Chưa xác định' ?></td> <!-- Xuất trạng thái quy trình cuối cùng -->
                                            </tr>
                                        <?php endforeach; ?>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-end">
                                        <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                                            <a class="page-link" href="QuanLyDon.php?page=<?= $page - 1 ?>&active=DangGiao">Previous</a>
                                        </li>
                                        <?php for ($i = 1; $i <= $total_pages_DangGiao; $i++) : ?>
                                            <li class="page-item  <?= $i == $page ? 'active' : '' ?>">
                                                <a class="page-link" href="QuanLyDon.php?page=<?= $i ?>&active=DangGiao"><?= $i ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        <li class="page-item <?= $page >= $total_pages_DangGiao ? 'disabled' : '' ?>">
                                            <a class="page-link" href="QuanLyDon.php?page=<?= $page + 1 ?>&active=DangGiao">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                            <div class="tab-pane fade <?= $active === 'huygiao'  ? 'show active' : '';
                                 $page = $active !== 'huygiao' ? 1 : ($_GET['page']); ?> " id="pills-huygiao" role="tabpanel" aria-labelledby="pills-huygiao-tab">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">STT</th>
